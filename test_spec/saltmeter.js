...
describe('Salt Meter', function(){
	...
	xit('I should be able to see the Salt score and the color of the salt', async function(){
	...
	xit('I should be able to see the health Result and the color of the health status', async function(){
	...
	it('I should be able to see "Calculate Again" button', function(){
		var calculateAgainButton = showResultsPage.calculateAgain();
		expect(calculateAgainButton).toBeDefined();
	});
